 ...
 *
 * One special case: a logged-out visit to the bare "/" path shows the
 * public landing page instead of redirecting to /login — this is the
 * ONLY path where behavior changed. Every other deep link (e.g.
 * /dashboard, /marketplace) still redirects a logged-out visitor
 * straight to /login exactly as before.
 */
