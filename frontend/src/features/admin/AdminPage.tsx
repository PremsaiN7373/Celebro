...
type View = "stats" | "users" | "planners" | "disputes";
  ...
  return (
    <div className="space-y-8 pb-16">
      <div>
        ...
        <p className="text-sm text-[#6B6780] mt-1 font-medium">Manage users, verified planners, disputes, and platform governance.</p>
      </div>

      <div className="flex gap-2 border-b border-[#E9E4F5] pb-3 overflow-x-auto">
        {(["stats", "users", "planners", "disputes"] as View[]).map((v) => (
          <button
            key={v}
            onClick={() => setView(v)}
